# GitHub build and automatic release

- For the rust console application in this repository please add a github workflow that will build and test the application.
